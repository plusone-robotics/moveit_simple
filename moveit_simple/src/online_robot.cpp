...
void OnlineRobot::execute(const std::string traj_name, bool collision_check, bool retime_trajectory, double max_velocity_scaling_factor, double max_acceleration_scaling_factor)
{
  ...
  try
  {
    ...
    execute(goal, false, retime_trajectory, max_velocity_scaling_factor, max_acceleration_scaling_factor);
  }
...
void OnlineRobot::execute(std::vector<moveit_simple::JointTrajectoryPoint> &joint_trajectory_points,
                          bool collision_check, bool retime_trajectory, double max_velocity_scaling_factor, double max_acceleration_scaling_factor)
{
  std::lock_guard<std::recursive_mutex> guard(m_);
  ...
  trajectory_processing::validateTrajectory(robot_model_ptr_, joint_group_->getName(), goal.trajectory, retime_trajectory, max_velocity_scaling_factor, max_acceleration_scaling_factor);
